      ...
      <div className="space-y-20 w-full mx-auto">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start space-y-10 lg:space-y-0 lg:space-x-10">
          ...
          <div className="w-full lg:w-1/2 space-y-6">
            ...
            <p className="text-[1.6rem] leading-relaxed">
              "Soća servis AD" je osnovan 1990. godine, na "Salajki", jednom od
              dva najstarija dela grada Novog Sada, na tačnoj lokaciji, gde su
              događaji i fakti od pre par vekova dali priču i osnov za naziv
              servisa - Soća.
            </p>
            <p className="text-[1.6rem] leading-relaxed">
              Izvorna delatnost je bila popravka veš mašina, bojlera i termičkih
              uređaja. Kao i svaka mlada firma, proteklo je nekoliko godina u
              "traženju svog mesta na tržištu", što je dovelo do razvoja i
              širenja delatnosti i na druge tehnike (mašine za suđe, sušare,
              ugradna tehnika, frigomehanika).
            </p>
            ...
            <div className="timeline space-y-5">
              {[
                ...
                <div key={index} className="flex items-center space-x-4">
                  ...
                  <div className="flex-1 p-4 bg-gray-700 md:text-[1.6rem] text-mintCream rounded-lg shadow-lg">
                    {item.text}
                  </div>
                </div>
              ))}
        ...
        <div className="p-6 bg-white rounded-lg shadow-lg">
          ...
          <p className="text-[1.6rem] leading-relaxed">
            ...
            klimatizacijom i ventilacijom. Servisiranje se radi po ugovoru, u
            garanciji i van garancije, za autorizovane brendove, kao i
            samostalno, po zahtevu korisnika.
          </p>
        </div>
        ...
        <div className="space-y-10">
          ...
          <div className="p-6 bg-white rounded-lg shadow-lg">
            ...
            <p className="text-[1.6rem] leading-relaxed">
              ...
              opreme za vešeraje i klimatizacije.
            </p>
            <p className="text-[1.6rem] leading-relaxed">
