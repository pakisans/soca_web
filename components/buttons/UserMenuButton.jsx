...
const UserMenu = ({ username }) => {
  ...
  const handleDataSocaClick = async () => {
    window.open('https://www.soca.rs/public/login', '_blank');
  ...
  return (
    <div className="flex items-center gap-10">
      ...
      <button
        onClick={handleDataSocaClick}
        className="text-[18px] hidden xl:block font-bold cursor-pointer text-night hover:text-offRed hover:scale-110"
      >
        DATA SOĆA
      </button>
    </div>
